...
async function getAccounts() {
    const balance = await web3.eth.getBalance(wualletAddress);
    return balance;
}


async function getQuickswap(n) {
const blockNumber = await web3.eth.getBlockNumber();
const events = await contractQuickswap.getPastEvents('Transfer',
            {
